...
const ResHeader = () => {
  ...
  return (
    <>
      <nav className='fixed top-0 z-50 w-full bg-primary'>
        <div className='px-3 py-3 lg:px-5 lg:pl-3'>
          <div className='flex items-center justify-between'>
            ...
            <button
              type='button'
              className='inline-flex items-center p-2 text-sm text-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary'
              onClick={toggleMenu}
            >
      ...
      <aside
        className={`fixed top-0 right-0 z-40 w-64 h-screen pt-20 transition-transform bg-primary border-l border-gray-200  ${
